...
public class Random_setting extends AppCompatActivity implements View.OnClickListener {

    private TextView count_t;
    private EditText b_id, b_name, b_content, b_note;
    ...
    private String[] MYCOLUMN = new String[]{"id", "name", "content", "note"};
    int tcount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.random_setting);
        setupViewComponent();
    }
    ...
    private void setupViewComponent() {
        ...
        b_content = (EditText) findViewById(R.id.edtGrp);
        b_note = (EditText) findViewById(R.id.edtAddr);
...
//            adapter.add(fld[0] + " " + fld[1] + " " + fld[2] + " " + fld[3]);
    ...
    private final Spinner.OnItemSelectedListener mSpnNameOnItemSelLis = new Spinner.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView parent, View view, int position,long id) {
            ...
            b_content .setText(fld[2]);
            b_note .setText(fld[3]);
            //-------目前所選的item---
            index = iSelect;
            //-------------------------------
            // -----新增完清空白在此---------------
...
//            e003.setText("");
    ...
    public void onClick(View v) {
        ...
        count_t.setText("共計:" + Integer.toString(dbHper.RecCount_rm()) + "筆");
        switch (v.getId()){
            case R.id.btIdtop:
                ctlFirst();
                break;
            ...
            case R.id.btnupdate:
                ...
                tcontent = b_content.getText().toString().trim();
                tnote = b_note.getText().toString().trim();
...
//--------------------------------
            ...
            //----------------------------------
            case R.id.btIdDel:
                Toast.makeText(getApplicationContext(), "暫不開放", Toast.LENGTH_LONG).show();
                // 刪除一筆導入DialogInterface.OnClickListener執行
//                MyAlertDialog aldDial = new MyAlertDialog(Random_setting.this);
...
//                aldDial.show();
            ...
            case R.id.btnAdd: //按下新增鈕
                ...
                if (tname.equals("") || tcontent.equals("")  ) {
                ...
                newRow.put("content", tcontent);
                newRow.put("note", tnote);
                //------------------------------
                ...
                if (rowID != -1) {
                    ...
                    b_content.setText("");
                    b_note.setText("");
                    msg = "新增記錄  成功 ! \n" + "目前資料表共有 " + dbHper.RecCount_rm() + " 筆記錄 !";
                    ctlLast();  //成功跳到最後一筆
                } else {
                    msg = "新增記錄  失敗 !";
                }
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeInsert_ran(nameValuePairs);  //真正執行新增
//-----------------------------------------------
    }
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case BUTTON_POSITIVE:
                    int rowsAffected = dbHper.clearRec_rm();   //--- 刪除所有資料
            ...
            Toast.makeText(Random_setting.this, msg, Toast.LENGTH_SHORT).show();
            index = 0;  //給index初始值
            setupViewComponent();
            showRec(index); //重構
        };
...
//                Toast.makeText(getBaseContext(), msg, Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.random_setting, menu);
        return true;
    }
