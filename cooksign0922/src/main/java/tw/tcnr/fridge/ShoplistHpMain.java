...
//-----------------------------------------------
        String result = Cook_DBConnector.executeInsert_Shoplist01(nameValuePairs);  //真正執行新增
//-----------------------------------------------
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeInsert_Shoplist02(nameValuePairs);  //真正執行新增
//-----------------------------------------------
...
//-----------------------------------------------
        String result = Cook_DBConnector.executeDelet_Shoplist01(nameValuePairs);   //執行刪除
//-----------------------------------------------
    }
...
//
    ...
    private void dbmysql() {
        ...
        nameValuePairs.add(sqlctl);
        try {
            String result = Cook_DBConnector.executeQuery_Shoplist01(nameValuePairs);//匯入mysql的資料
            //==========================================
...
//                    }
    ...
    private void dbmysql_shoplist02() {
        ...
        nameValuePairs.add(sqlctl);
        try {
            String result = Cook_DBConnector.executeQuery_Shoplist02(nameValuePairs);//匯入mysql的資料
            //==========================================
            //chk_httpstate();  //檢查 連結狀態
            //==========================================
            /**************************************************************************
